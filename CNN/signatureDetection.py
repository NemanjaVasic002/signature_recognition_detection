...
from practice import plot_highlighted_histogram
...
#number of your signature in your model
...
#for extractor this is best solution for image shot with smartphone camera, for scanned img you should use different values
    ...
    plot_highlighted_histogram(imagePath)
...
#use this if you want to see avg sizes of the cropped regions
